		...
		if (mysqli_num_rows($r) > 0 ) { 
			while ($row = mysqli_fetch_array($r)) {
				...
				<td width=\"5%\" class=\"text-center\">{$row['donation_id']}</td>
					...
					<td width=\"10%\" class=\"text-center\"><a href=\"donatehistorydetails.php?donation_id=$donation_id\"><button class=\"btn btn-dark rounded-circle\" style=\"width:38px;height:38px\"><i class=\"fa fa-angle-right text-light\" style=\"font-size:14pt\"></i></button></a></td>
			   </tr>";
			}
		}
		else {
