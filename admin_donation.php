...
<html>
        ...
        function drawChart() {
            ...
            <?php
                ...
                while($result = mysqli_fetch_assoc($query)){
                    echo"['" .$result['donation_datetime']. "'," .$result['donation_amount']."],";
                }
            ?>
            ]);

            var options = {
            title: 'FurryPets Donation',
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
          ...
          <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="manageShop.php"><i class="fa-solid fa-shop"></i> Manage Shop</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="admin_donation.php"><i class="fa-solid fa-hand-holding-dollar"></i> Donation History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="paymentHistory.php"><i class="fa-solid fa-money-check"></i> Payment History</a>
                </li>
              </ul>
        ...
        <?php
            ...
            $query = "SELECT SUM(donation_amount) AS total_amount FROM donation";
            ...
            <br/>
            <h1 align="center">Total Donation</h1>
            <br/>
